...
# Two real routes on THIS site — the template's /networks and /backends do
# not exist here. Both are ordinary markdown docs pages registered through
# pages/markdown.py, which is the shape every assertion below assumes; the
# fixtures gate GATED_PAGE themselves, so neither page's own frontmatter
# needs a tier (and none of this site's 39 pages declares one).
GATED_PAGE = "/linechart-basic"
PUBLIC_PAGE = "/sparkline"
