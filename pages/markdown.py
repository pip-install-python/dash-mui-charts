...
def _expand_source_directives(markdown_content: str) -> str:
    ...
    serves broken structure (found on the template 2026-08-23 by the
    single-h1 pin: five h1s on the tutorial page of every fork; the
    browser lane was never affected because markdown2dash parses fences
    properly).

    PREVENTIVE HERE, not corrective: this repo's 39 markdown pages carry
    no `.. source::` inside a fence today — measured, not assumed. It is
