...
dash.register_page(
    __name__,
    path='/linechart-basic',
    name='LineChart Basics',
    title=PAGE_TITLE_PREFIX + 'LineChart Basics',
    description='Fundamentals of the LineChart Dash component: grid, area and '
                'stacked-area charts, curve interpolation, dual y-axes, and '
