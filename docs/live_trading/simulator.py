"""LiveTradingChart simulator — the whole control surface.

Rendered on /live-trading via `.. exec::`; ported verbatim from the
pre-migration pages/live_trading.py (same ids, same callbacks).
"""
import os
